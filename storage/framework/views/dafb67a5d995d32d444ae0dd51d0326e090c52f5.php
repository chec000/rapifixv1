            ...
            <div class="col-lg-9 col-md-12">
                <div class="row">
                    <div class="col-lg-5 col-md-7">
                     <div class="single-product-img img-full">
                        <img src="<?php echo e($countryProduct->image); ?>" class="img-fluid" alt="">
                        <a href="<?php echo e($countryProduct->image); ?>" class="big-image-popup"><i class="fa fa-search-plus"></i></a>
                    </div>
                ...
                <div class="col-lg-7 col-md-5">
                    ...
                    <div class="product-options">
                        <h2 class="product-title"><?php echo e($countryProduct->name); ?></h2>
                        <p class="condition"><span>Condition:</span> New</p>
                        <h2 class="product-price">$<?php echo e($countryProduct->price); ?></h2>
                        <p class="product-description">
                            <?php echo e($countryProduct->description); ?>
                        ...
                        <span onclick="ShoppingCart.add_to_item('<?php echo e($countryProduct->id); ?>', 2)" class="add-to-cart-btn">
                ...
                <div class="row">
                   ...
                   <div class="col-lg-12">
                    ...
                    <div class="horizontal-product-list">
                        <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="single-product">
                            <div class="single-product-content">
                                <div class="product-image">
                                    <a href="<?php echo e(route('products.detail', ['product_slug' => $pr->relatedProduct->slug])); ?>">
                                        <img src="<?php echo e($pr->relatedProduct->image); ?>" class="img-fluid" alt="">
                                ...
                                <h5 class="product-name"><a href="<?php echo e(route('products.detail', ['product_slug' => $pr->relatedProduct->slug])); ?>"><?php echo e($pr->relatedProduct->name); ?></a></h5>
                                <div class="price-box">
                                    <h4><?php echo e($pr->relatedProduct->price); ?></h4>
                                </div>
                                <span onclick="ShoppingCart.add('<?php echo e($pr->relatedProduct->id); ?>', 1)" class="add-to-cart-btn">                                Agregar al carrito
                                    <i class="fa fa-shopping-cart"></i>
                                </span>
