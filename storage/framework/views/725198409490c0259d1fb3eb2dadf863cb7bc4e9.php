        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-4 offset-lg-0 text-md-left text-sm-center">
                    <!-- logo -->
                    <div class="logo">
                        <a href="/"><img src="<?php echo e(asset('cms/app/img/logo.png')); ?>" class="img-fluid" alt="logo"></a>
                    </div>
                    <!-- end of logo -->
                </div>
                        ...
                        <div class="input-group">
                            <select name="categoryName" id="categoryName">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($c->id); ?>}"><a href="<?php echo e(route('category.products', ['id' => $c->id])); ?>"><?php echo e($c->name); ?></a></option>
                ...
                <div class="col-lg-3 col-md-4">
                    <!-- shopping cart -->
                    <?php echo PageBuilder::section('cart',['cart'=>$cart]); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12">
                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    <li class="active menu-item-has-children"><a href="<?php echo e(url('/')); ?>">Home</a>
