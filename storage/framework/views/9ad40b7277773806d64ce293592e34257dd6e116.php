...
<html lang="es">
    ...
    <!-- Custom fonts for this template -->
        ...
        <script type="text/javascript" src="<?php echo e(asset('cms/inicio/js/vendor/modernizr-2.8.3.min.js')); ?>"></script>
        <!-- Modernizer JS -->
                                            ...
                                            <div class="hero-side-category">
                                                ...
                                                <nav class="category-menu mb-40">
                                                    <ul>
                                                        ...
                                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li><a href="shop-left-sidebar.html"><?php echo e($c->name); ?></a></li>
                                                                    ...
                                                                    <div class="vertical-product-list">
                                                                        ...
                                                                        <?php $__currentLoopData = $c->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                            <div class="single-vertical-product d-flex">
                                                                                <div class="product-image">
                                                                                    <a href="#"><img src="<?php echo e($p->image); ?>" class="img-fluid" alt=""></a>
                                                                                </div>
                                                                                <div class="product-description">
                                                                                    <h5 class="product-name">
    ...
    <!-- jQuery JS -->
        ...
        <script type="text/javascript"  src="<?php echo e(asset('cms/inicio/js/vendor/jquery.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('cms/inicio/js/vendor/modernizr-2.8.3.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('cms/inicio/js/popper.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('cms/inicio/js/vendor/modernizr-2.8.3.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('cms/inicio/js/bootstrap.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('cms/inicio/js/plugins.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('cms/inicio/js/main.js')); ?>"></script>
