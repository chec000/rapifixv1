<?php echo PageBuilder::section('head'); ?>
    ...
    <div class="mainslider contact" style="padding: 0px;">
        <div class="slider__wrap">
            <div class="slider__item" style="background-image:url(<?php echo e(PageBuilder::block('main_contact_image', ['view' => 'raw'])); ?>);">
    ...
    <div class="wrapper full-size-mobile business__main">
        <div class="business__main-title col3-4">
            <div class="business__main-inner">
                <h3 class="products-maintitle"><?php echo PageBuilder::block('contact_title'); ?><span> <?php echo PageBuilder::block('contact_title_highlight'); ?></span></h3>
            </div>
        </div>
        ...
        <div class="business__slider slider" id="business-slider">
            <div class="contact--container">
                <div class="contact--description">
                    <?php echo PageBuilder::block('contact_info_text'); ?>
            ...
            <div class="contact--list">
                <header class="ezone__header">
                    <div class="ezone__headline bordered">
                        <h1 class="ezone__title"><?php echo PageBuilder::block('contact_list_title'); ?></h1>
                    </div>
                </header>
                <div class="contact--list__creo">
                    <div class="business__slider slider" id="business-slider">
                        <?php echo PageBuilder::block('contact_info_tels'); ?>
