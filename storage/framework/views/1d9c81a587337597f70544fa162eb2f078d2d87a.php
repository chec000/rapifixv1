<h1><?php echo trans('admin::themes.labels.title'); ?></h1>

<p><?php echo trans('admin::themes.labels.subtitle'); ?><br /><br /></p>

<?php echo $themes_installed; ?>
...
<?php if($can_upload): ?>
    <div class="row">
        ...
        <div class="col-sm-12">
            ...
            <?php echo Form::open(['url' => route('admin.themes.manage'), 'id' => 'uploadThemeForm', 'enctype' => 'multipart/form-data']); ?>

            <span class="btn btn-primary fileinput-nice">
            <i class="glyphicon glyphicon-upload glyphicon-white"></i>
            <span><?php echo trans('admin::themes.buttons.upload_teme'); ?></span>
