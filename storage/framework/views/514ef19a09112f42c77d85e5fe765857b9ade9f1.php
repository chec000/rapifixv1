...
<head>
    ...
    <meta name="generator" content="Omnilife CMS <?php echo e(config('cms.site.version')); ?>">
  ...
  <link href="<?php echo asset('/themes/omnilife2018/css/complementos.css'); ?>" rel="stylesheet">
...
<nav class="navbar navbar-default navbar-fixhed-top">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="logo" href="<?php echo e(route('admin.home')); ?>">
                <img style="height: 63px" src="<?php echo e(URL::to(config('admin.config.public'))); ?>/app/img/logo.png" alt="Omnilife CMS"/>
            </a>
        </div>
...
<div class="loader" style=" opacity: 0.5;background-color: #f1eaea;">
    <div class="loader__content">
        <div class="loader__inner">
            <img src="<?php echo e(asset('themes/omnilife2018/images/cargando-loading-041.gif')); ?>">            
        </div>
    </div>
</div>
<style>
...
<script src="<?php echo e(URL::to(config('admin.config.public')).'/app/js/router.js'); ?>"></script>
<script type="text/javascript">
    var dateFormat = '<?php echo e(config('cms.date.format.jq_date')); ?>';
    var timeFormat = '<?php echo e(config('cms.date.format.jq_time')); ?>';
    var ytBrowserKey = '<?php echo e(config('settings::key.yt_browser') ?: config('cms.key.yt_browser')); ?>';
    var adminPublicUrl = '<?php echo e(URL::to(config('admin.config.public')).'/'); ?>';
...
<script type="text/javascript">
    var _URL_PROJECT = '<?php echo e(route('admin.home')); ?>';
    $.ajaxSetup({
        statusCode: {
            419: function () {
