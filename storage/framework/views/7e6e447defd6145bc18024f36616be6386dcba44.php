                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="single-footer-nav-block">
                                ...
                                <li><a href="<?php echo e(route('category.products', ['id' => $c->id])); ?>">
            <?php echo e($c->name); ?></a></li>
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        var shopping_cart = <?php echo ShoppingCart::sessionToJson(3); ?>;
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            products = <?php echo ShoppingCart::productsToJson($category->groupProducts->where('active', 1)->where('product_category', 1)->where('delete', 0)); ?>;
