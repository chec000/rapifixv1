<h1>Theme Editor (<?php echo $theme->theme; ?>)</h1>
...
<div class="col-md-8 content">
  <?php echo Form::open(); ?>
    ...
    <?php echo Form::hidden('theme_id', $theme->id); ?>

    <?php echo Form::hidden('path', '', array('id' => 'path-inp')); ?>

    <?php echo Form::textarea('file', '', array('class' => 'hidden', 'id' => 'file_content_ta')); ?>

    <pre id="editor"></pre>
    <?php echo Form::submit('Save file', ['class' => 'btn btn-promary']); ?>

  <?php echo Form::close(); ?>

  <a href="<?php echo e(route('admin.themes.list')); ?>" class="btn btn-default pull-right"><span class="fa fa-chevron-left"></span>&nbsp;back to themes</a>
</div>
...
<?php $__env->startSection('scripts'); ?>
    <script type='text/javascript'>
        $(document).ready(function () {
          ...
          var rte = route('admin.themes.edit.loadfile');
