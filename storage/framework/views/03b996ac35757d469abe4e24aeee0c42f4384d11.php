<?php $__env->startSection('styles'); ?>
    <?php if($brand->id == 1): ?>
        <link rel="stylesheet" href="<?php echo e(asset('cms/app/css/omnilife.css')); ?>">
    <?php endif; ?>

    <?php if($brand->id == 2): ?>
        <link rel="stylesheet" href="<?php echo e(asset('cms/app/css/seytu.css')); ?>">
    <?php endif; ?>
...
<div class="container">
    ...
    <?php endif; ?>
    <h1><?php echo trans('admin::shopping.categories.add.view.title-edit'); ?></h1>
    <form id="categories" method="POST" action="<?php echo e(route('admin.categories.update', [$code])); ?>">
        ...
        <div class="form-group">
            <?php $__currentLoopData = Auth::user()->userBrandsPermission(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uB): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($brand->id == $uB['id']): ?>
                    <p class="lead">Brand: <strong><?php echo e($uB['name']); ?></strong></p>
                    <input type="hidden" name="brand_id" id="brand_id" value="<?php echo e($brand->id); ?>">
                <?php endif; ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="global_name" id="global_name" class="form-control" required="required" value="<?php echo e($globalName); ?>">
        </div>

        <div class="form-group">
            <label><?php echo app('translator')->getFromJson('admin::shopping.categories.add.view.form-country'); ?></label><br />
            <ul id="countryForm" class="nav nav-tabs" role="tablist">
                <?php $__currentLoopData = $categoriesByCountry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(in_array($category->country->id, $countriesByBrand)): ?>
                        <li data-country-tab="<?php echo e($category->country->id); ?>" role="presentation">
                            <a href="#<?php echo e(str_replace(' ', '_', $category->country->name)); ?>" aria-controls="home" role="tab" data-toggle="tab">
                                <?php echo e($category->country->name); ?> <i class="fa fa-caret-square-o-down" aria-hidden="true"></i>
                            </a>
                        </li>
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="tab-content">
                <?php $__currentLoopData = $categoriesByCountry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(in_array($category->country->id, $countriesByBrand)): ?>
                        <div data-country-pane="<?php echo e($category->country->id); ?>" role="tabpanel" class="tab-pane" id="<?php echo e(str_replace(' ', '_', $category->country->name)); ?>"> <br />

                            <div class="form-group">
                                <label for="color"><?php echo e(trans('admin::shopping.categories.index.color')); ?></label>
                                <div id="bcolor_<?php echo e($category->country->id); ?>_<?php echo e($brand->id); ?>" class="products-page inner <?php echo e($category->color); ?>"></div>
                                <select class="form-control select-color" name="color_<?php echo e($category->country->id); ?>" data-brand="<?php echo e($brand->id); ?>">
                                    <option value=""><?php echo e(trans('admin::shopping.categories.index.default')); ?></option>
                                    <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e($category->color == $class ? 'selected' : ''); ?> value="<?php echo e($class); ?>"><?php echo e(ucfirst($class)); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>

                            <div class="form-group">
                                <label for="oder_<?php echo e($category->country->id); ?>"><?php echo app('translator')->getFromJson('admin::shopping.categories.add.input.order'); ?> *</label>
                                <input name="order_<?php echo e($category->country->id); ?>"
                                       type="number" min="1" max="30"
                                       class="form-control"
                                       id="order_<?php echo e($category->id); ?>"
                            ...
                            <?php $__currentLoopData = Auth::user()->getCountryLang($category->country->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $langCountry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div role="panel-group" id="accordion-<?php echo e($category->country->id); ?>-<?php echo e($langCountry->id); ?>">
                                    <div class="panel panel-default">
                                        <div role="tab" class="panel-heading">
                                            <h4 class="panel-title">
                                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#product-language-<?php echo e($category->country->id); ?>-<?php echo e($langCountry->id); ?>">
                                                    <?php echo e(trans('admin::shopping.products.add.second_general_tab.country-language-title') . $langCountry->language); ?>

                                                </a>
                                            </h4>
                                        </div>
                                        <div role="tabpanel" data-parent="#accordion" class="panel-collapse collapse" id="product-language-<?php echo e($category->country->id); ?>-<?php echo e($langCountry->id); ?>" >
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->getFromJson('admin::shopping.categories.add.input.category'); ?></label>
                                                            <input name="category_<?php echo e($category->country->id); ?>_<?php echo e($langCountry->id); ?>"
                                                                   type="text" rel="requerido_<?php echo e($category->country->id); ?>"
                                                                   class="requerido requerido_<?php echo e($category->country->id); ?> requerido_<?php echo e($category->country->id); ?>_<?php echo e($langCountry->id); ?> form-control"
                                                                   id="requerido_<?php echo e($category->country->id); ?>_<?php echo e($langCountry->id); ?>"
                                                                   placeholder="<?php echo app('translator')->getFromJson('admin::shopping.categories.add.input.category'); ?>"
                                                                   <?php if(isset($category->translate($langCountry->locale_key)->name) && !empty($category->translate($langCountry->locale_key)->name)): ?>
                                                                       value="<?php echo e($category->translate($langCountry->locale_key)->name); ?>"
                                                                   <?php else: ?>
                                                                       value="<?php echo e(old('category_'.$category->country->id.'_'.$langCountry->id)); ?>"
                                                                   <?php endif; ?>>
                                                        </div>

                                                        <div class="form-group">
                                                            <label class="control-label"
                                                                   for="product-image-<?php echo e($category->country->id); ?>-<?php echo e($langCountry->id); ?>">
                                                                <?php echo e(trans('admin::shopping.categories.add.input.select_banner')); ?>

                                                            </label>
                                                            <!--<input type="hidden" name="langId__"
                                                                   value=""
                                                                   >-->
                                                            <div class="input-group">
                                                                <input name="image_<?php echo e($category->country->id); ?>_<?php echo e($langCountry->id); ?>" readonly="true"
                                                                       type="text" id="image_<?php echo e($category->country->id); ?>_<?php echo e($langCountry->id); ?>"
                                                                       class="img_src requerido_<?php echo e($category->country->id); ?>_<?php echo e($langCountry->id); ?> form-control"
                                                                       <?php if(isset($category->translate($langCountry->locale_key)->image_banner) && !empty($category->translate($langCountry->locale_key)->image_banner)): ?>
                                                                            value="<?php echo e($category->translate($langCountry->locale_key)->image_banner); ?>"
                                                                       <?php else: ?>
                                                                            value="<?php echo e(old('image_'.$category->country->id.'_'.$langCountry->id)); ?>"
                                                                       <?php endif; ?>>
                                                                <span class="input-group-btn">
                                                                    <a href="<?php echo URL::to(config('admin.config.public') . '/filemanager/dialog.php?type=1&field_id=image_'.$category->country->id.'_'.$langCountry->id); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <label><?php echo app('translator')->getFromJson('admin::shopping.categories.add.input.description'); ?></label>
                                                            <textarea name="description_<?php echo e($category->country->id); ?>_<?php echo e($langCountry->id); ?>"
                                                                      class="form-control" rows="3"
                                                                      placeholder="<?php echo app('translator')->getFromJson('admin::shopping.categories.add.input.description'); ?>"><?php if(isset($category->translate($langCountry->locale_key)->description)): ?><?php echo e(strip_tags($category->translate($langCountry->locale_key)->description)); ?><?php else: ?><?php echo e(strip_tags(old('description_'.$category->country->id.'_'.$langCountry->id))); ?><?php endif; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <hr />
                            <div class="form-group">
                                <label><?php echo app('translator')->getFromJson('admin::shopping.categories.add.view.form-banner-link'); ?></label>
                                <input name="bannerLink_<?php echo e($category->country->id); ?>" type="text" class="form-control"
                                       placeholder="<?php echo app('translator')->getFromJson('admin::shopping.categories.add.input.banner-link'); ?>"
                                       <?php if(isset($category->link_banner)): ?>
                                           value="<?php echo e($category->link_banner); ?>"
                                       <?php else: ?>
                                           value="<?php echo e(old('bannerLink_'.$category->country->id)); ?>"
                                       <?php endif; ?>>
                            </div>
                            <div class="form-group">
                                <label><?php echo app('translator')->getFromJson('admin::shopping.categories.add.view.form-active'); ?></label>
                                <?php $valActive = 0; ?>
                                <?php if(isset($category->active)): ?>
                                ...
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="active_<?php echo e($category->country->id); ?>" value="1"  <?php echo e($valActive == 1 ? ' checked' : ''); ?> > Si
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="active_<?php echo e($category->country->id); ?>" value="0" <?php echo e($valActive == 0 ? ' checked' : ''); ?>> No
                                    </label>
                                </div>
                            </div><br />
                            <div class="form-group">
                                <label><?php echo app('translator')->getFromJson('admin::shopping.categories.add.view.form-product-select'); ?></label>
                                <input type="hidden" name="products_<?php echo e($category->country->id); ?>" id="products_<?php echo e($category->country->id); ?>" class="form-control"
                                       value="<?php echo e(isset($products[$category->country->id]) ? $products[$category->country->id] : ''); ?>"/>
                                <input type="hidden" name="code_<?php echo e($category->country->id); ?>" id="products_<?php echo e($category->country->id); ?>" class="form-control"
                                       value="<?php echo e($code); ?>"/>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div id="alert_<?php echo e($category->country->id); ?>" class="alert alert-danger btn-xs" role="alert" style="display: none; padding: 5px">
                                            <?php echo app('translator')->getFromJson('admin::shopping.categories.add.error.select-product'); ?>
                                        </div>
                                    </div>
                                    <div class="col-xs-10">
                                        <select class="form-control" id="sel_<?php echo e($category->country->id); ?>">
                                            <option id="opt_<?php echo e($category->country->id); ?>" value="">
                                                <?php echo app('translator')->getFromJson('admin::shopping.categories.add.input.product'); ?>
                                            </option>
                                            <?php $__currentLoopData = Auth::user()->activeProductsByCountryAndBrand($category->country->id, $brand->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option id="opt_<?php echo e($prod->id); ?>_<?php echo e($category->country->id); ?>" value="<?php echo e($prod->id); ?>"><?php echo e($prod->product->sku); ?> - <?php echo e($prod->product->global_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                    <div class="col-xs-2">
                                        <button type="button" class="btn btn-default"
                                                onclick="addProduct(<?php echo e($category->country->id); ?>, <?php echo e(Auth::user()->activeProductsByCountryAndBrand($category->country->id, $brand->id)); ?>)">
                            ...
                            <div class="form-group">
                                <div id="alert_limit_<?php echo e($category->country->id); ?>" class="alert alert-danger btn-xs" role="alert" style="display: none; padding: 5px">
                                    <?php echo app('translator')->getFromJson('admin::shopping.categories.add.error.select-category'); ?>
                                </div>
                                <div id="alert_limit_home<?php echo e($category->country->id); ?>" class="alert alert-danger btn-xs" role="alert" style="display: none; padding: 5px">
                                    <?php echo app('translator')->getFromJson('admin::shopping.categories.add.error.select-banner'); ?>
                                </div>
                                <div id="alert_limit_category<?php echo e($category->country->id); ?>" class="alert alert-danger btn-xs" role="alert" style="display: none; padding: 5px">
                                ...
                                <table class="table text-center">
                                    ...
                                    <?php $__currentLoopData = Auth::user()->activeProductsByCountryAndBrand($category->country->id, $brand->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="dis_<?php echo e($prod->id); ?>_<?php echo e($category->country->id); ?>" style="display: none">
                                            <td><?php echo e($prod->id); ?></td>
                                            <td><?php echo e($prod->product->sku); ?></td>
                                            <td><?php echo e($prod->product->global_name); ?></td>
                                            <td class="text-center">
                                                <i id="favOff_<?php echo e($prod->id.'_'.$category->country->id); ?>" class="fa fa-eye-slash fa-2x"
                                                   aria-hidden="true" onclick="addFavorite(<?php echo e($prod->id); ?>,<?php echo e($category->country->id); ?>)"></i>
                                                <i id="favOn_<?php echo e($prod->id.'_'.$category->country->id); ?>" class="fa fa-eye fa-2x"
                                                   aria-hidden="true" onclick="quitFavorite(<?php echo e($prod->id); ?>,<?php echo e($category->country->id); ?>)"
                                                   style="color: green;display: none"></i>
                                            </td>
                                            <td class="text-center">
                                                <i id="catOff_<?php echo e($prod->id.'_'.$category->country->id); ?>" class="fa fa-eye-slash fa-2x"
                                                   aria-hidden="true" onclick="addCat(<?php echo e($prod->id); ?>,<?php echo e($category->country->id); ?>)"></i>
                                                <i id="catOn_<?php echo e($prod->id.'_'.$category->country->id); ?>" class="fa fa-eye fa-2x"
                                                   aria-hidden="true" onclick="quitCat(<?php echo e($prod->id); ?>,<?php echo e($category->country->id); ?>)"
                                                   style="color: green;display: none"></i>
                                            </td>
                                            <td>
                                                <i id="<?php echo e($prod->id); ?>|<?php echo e($category->country->name); ?>" class="del_btn fa fa-trash fa-2x"
                                                   aria-hidden="true" onclick="delProduct(<?php echo e($prod->id); ?>,'<?php echo e($category->country->id); ?>')"></i>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </table>
                ...
                <?php $__currentLoopData = $anotherCountries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $uC): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div role="tabpanel" class="tab-pane" id="<?php echo e(str_replace(' ', '_', $uC->name)); ?>" data-country-pane="<?php echo e($uC->id); ?>"> <br />
                        ...
                        <div class="form-group">
                            <label for="color"><?php echo e(trans('admin::shopping.categories.index.color')); ?></label>
                            <div id="bcolor_<?php echo e($uC->id); ?>_<?php echo e($brand->id); ?>" class="products-page inner"></div>
                            <select class="form-control select-color" name="color_<?php echo e($uC->id); ?>" data-brand="<?php echo e($brand->id); ?>">
                                <option value=""><?php echo e(trans('admin::shopping.categories.index.default')); ?></option>
                                <?php $__currentLoopData = $colors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-10">
                                    <select class="form-control" id="sel_<?php echo e($uC->id); ?>">
                                        ...
                                        <?php $__currentLoopData = Auth::user()->activeProductsByCountryAndBrand($uC->id, $brand->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-xs-2">
                                    <button type="button" class="btn btn-default"
                                            onclick="addProduct(<?php echo e($uC->id); ?>, <?php echo e(Auth::user()->activeProductsByCountryAndBrand($uC->id, $brand->id)); ?>)">
                                        <?php echo app('translator')->getFromJson('admin::shopping.categories.add.view.form-add-button'); ?>
                                    </button>
                                </div>
                            </div>
