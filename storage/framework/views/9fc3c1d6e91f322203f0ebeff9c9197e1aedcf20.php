<h1> <?php echo e(trans('admin::shopping.securityquestions.add.new_securityquestions')); ?></h1>
<p class="text-right"><a href="<?php echo e(route('admin.securityquestions.list')); ?>"><?php echo e(trans('admin::shopping.securityquestions.add.back_list')); ?></a></p>
<?php echo Form::open( ['id'=>'form_add_securityquestions']); ?>



<fieldset class="fieldset_gray">
    <legend class="legend_gray"><?php echo trans('admin::shopping.securityquestions.add.legend_add'); ?></legend>
        <div class="col-md-6">
            <div  class= "form-group <?php echo FormMessage::getErrorClass('key'); ?>">
                <?php echo Form::label('key', trans('admin::shopping.securityquestions.add.key'), ['class' => 'control-label']); ?>


                <?php echo Form::text('key', isset($securityquestions->key)? $securityquestions->key:'', ['required','class' => 'form-control','id'=>'key']); ?>
        ...
        <div class="col-md-6">
            <div class="form-group   <?php echo FormMessage::getErrorClass('country_id'); ?>">
                <?php echo Form::label('country_id', trans('admin::shopping.securityquestions.add.countries'), ['class' => 'control-label']); ?>
...
<?php if(isset($add)): ?>
<h3><?php echo e(trans('admin::shopping.securityquestions.add.oe_translates')); ?></h3>
<p class="text-danger" style="font-style: italic;"><?php echo e(trans('admin::shopping.securityquestions.add.oe_disclaimer')); ?></p>
<?php if($errors->any()): ?>
             ...
             class="panel-collapse <?php echo e(($lan['id'] == Session::get('language') || $errors->has('role_data['.$lan->id.'][name]')) ? 'in' : 'collapse'); ?>" >
                     <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <label for="language_lang" class="control-label"><?php echo e(trans('admin::shopping.securityquestions.add.name')); ?></label>
                            <input  class="form-control" name="securityquestions_name[<?php echo e($lan->locale_key); ?>]" value="<?php echo e(old('securityquestions_name.'.$lan->locale_key)); ?>" type="text">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="hidden" name="securityquestions_locale[]" value="<?php echo $lan->locale_key; ?>">
...
<div class="form-group">
        ...
        <?php echo e(trans('admin::shopping.securityquestions.add.btn_add')); ?>
