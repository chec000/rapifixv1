                        ...
                        <div class="hero-side-category">
                            ...
                            <nav class="category-menu mb-40">
                                <ul>
                                    ...
                                    <li class="<?php echo e((count($c['children'])>0)?'menu-item-has-children':''); ?>"><a href="<?php echo e(route('category.products', ['id' => $c->id])); ?>"><?php echo e($c->name); ?></a>
                                       <?php if((count($c['children'])>0)): ?>   
                                       <ul class="category-mega-menu">
                                        <?php $__currentLoopData = $c['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="menu-item-has-children">
                                          
                                          <a class="megamenu-head" href="<?php echo e(route('category.products', ['id' => $h->id])); ?>"

                                              >
                                              <?php echo e($h->name); ?>

                                          </a>
                                          <?php if(count($h->products)): ?>
                                          <ul>
                                           <?php $__currentLoopData = $h->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <li><a href="<?php echo e(route('products.detail', ['product_slug' => $p->slug])); ?>">
                                               <?php echo e($p->name); ?>
    ...
    <div class="row">
        <div class="col-lg-3 col-md-4 mb-50">
            ...
            <div class="homepage-sidebar">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="sidebar">
                    <h2 class="block-title"><?php echo e($c->name); ?></h2>
                                ...
                                <div class="single-auto-vertical-product d-flex">
                                    <div class="product-image">
                                        ...
                                        <a href="<?php echo e(route('products.detail', ['product_slug' => $p->slug])); ?>">
                                            <img src="<?php echo e($p->image); ?>" class="img-fluid" alt=""></a>
                                        </div>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="vertical-product-slider-container">
                                <div class="single-vertical-slider">
                                    <div class="vertical-auto-slider-product-list">
                                        <!-- single vertical product -->
                                        <?php $__currentLoopData = $latest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="single-auto-vertical-product d-flex">
                                            <div class="product-image">
                                                <a href="<?php echo e(route('products.detail', ['product_slug' => $lp->slug])); ?>"><img src="<?php echo e(asset($lp->image)); ?>" class="img-fluid" alt=""></a>
                                            </div>
                                            <div class="product-description">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="block-title">
                                        <h2><a href="#"><?php echo e($c->name); ?></a></h2>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="horizontal-product-list">
                                        ...
                                        <div class="single-product">
                                            <div class="single-product-content">
                                                ...
                                                <span onclick="ShoppingCart.add('<?php echo e($p->id); ?>', 1)" class="add-to-cart-btn">                                add to car
                        ...
                        <div class="vertical-product-slider-container">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="single-vertical-slider">
                                        <h2 class="block-title vertical-slider-block-title"><?php echo e($c->name); ?></h2>
                                        <div class="vertical-product-list">
                                            ...
                                            <div class="single-vertical-product d-flex">
                                                <div class="product-image">
                                                    <a href="<?php echo e(route('products.detail', ['product_slug' => $p->slug])); ?>"><img src="<?php echo e($p->image); ?>" class="img-fluid" alt=""></a>
                                                </div>
                                                <div class="product-description">
                                                    <h5 class="product-name">
                                                        <a href="<?php echo e(route('products.detail', ['product_slug' => $p->slug])); ?>"><?php echo e($p->name); ?> </a></h5>
                                                        <div class="price-box">
                                                            <h4><?php echo e($p->price); ?></h4>
                                                        </div>
                                                        <span onclick="ShoppingCart.add('<?php echo e($p->id); ?>', 1)" class="add-to-cart-btn">                                                                    add to car
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="home-wide-bg-container mb-50">
                            <a class="banner-width-bg-link" href="#">
                                <img src="<?php echo e(asset('cms/inicio/images/banners/banner-wide.jpg')); ?>" alt="">
                            </a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-6">
                            ...
                            <div class="single-latest-product">
                                <div class="product-image">
                                    <a href="<?php echo e(route('products.detail', ['product_slug' => $lp->slug])); ?>">
                                        <img src="<?php echo e(asset($lp->image)); ?>" class="img-fluid" alt="">
                                        <img src="<?php echo e(asset($lp->image)); ?>" class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="product-description">
                                    <h5 class="product-name"><a href="#"><?php echo e($lp->name); ?></a></h5>
                                    <div class="price-box">
                                        <h4>$ <?php echo e($lp->price); ?></h4>
                                    </div>
                                </div>
