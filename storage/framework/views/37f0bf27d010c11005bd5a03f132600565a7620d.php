                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" id="products-check-countries">
                            ...
                            <?php $__currentLoopData = $countryUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div data-country-checkbox="<?php echo e($country['id']); ?>" class="checkbox" id="check-countries">
                                    <input type="checkbox" class="form-check-input" id="checkCountry_<?php echo e($country['id']); ?>" value="<?php echo e($country['id']); ?>" onclick="checkCountry('<?php echo e($country['id']); ?>')">
                                    <input type="hidden" id="country-langs-<?php echo e($country['id']); ?>" value="<?php echo e(json_encode($country['languages'])); ?>">
                                    <label for="checkCountry_<?php echo e($country['id']); ?>" id="label-langsCountry_<?php echo e($country['id']); ?>" class="form-check-label"><?php echo e($country['name']); ?></label>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                                ...
                                <div role="tabpanel" class="tab-pane " id="produc-country-information-<?php echo e($country['id']); ?>">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label class="control-label">
                                                                                <?php echo e(trans('admin::shopping.products.add.second_general_tab.form-product-ingredients-label')); ?>
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <input class="img_src form-control" readonly="true" rel="obligatorio"
                                                                                       type="text" name="product-image-<?php echo e($country['id']); ?>-<?php echo e($language['id']); ?>"
                                                                                       id="product-image-<?php echo e($country['id']); ?>-<?php echo e($language['id']); ?>">
                                                                                <span class="input-group-btn">
                                                                            <a href="<?php echo URL::to(config('admin.config.public') . '/filemanager/dialog.php?type=1&field_id=product-image-'.$country['id'].'-'.$language['id']); ?>" class="btn btn-default iframe-btn"><?php echo e(trans('admin::countries.add_btn_image')); ?></a>
                                                                        </span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="control-label">
                                                                                <?php echo e(trans('admin::shopping.products.add.second_general_tab.form-product-nutritional-info-label')); ?>

                                                                            </label>
                                                                            <div class="input-group">
                                                                                <input class="img_src form-control" readonly="true" rel=""
                                                                                       type="text"  name="product-nutritional-info-<?php echo e($country['id']); ?>-<?php echo e($language['id']); ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="products_<?php echo e($country['id']); ?>" id="products_<?php echo e($country['id']); ?>" class="form-control"
                                               value="<?php echo e(isset($prods['product'][$country['id']]) ? $prods['product'][$country['id']] : ''); ?>"/>
                                        <div class="row">
                                            <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-10">
                                                <select class="form-control" id="sel_<?php echo e($country['id']); ?>">
                                                    <option id="opt_<?php echo e($country['id']); ?>" value="">
                                                        <?php echo app('translator')->getFromJson('admin::shopping.products.add.input.product'); ?>
                                                    </option>
                                                    <?php $__currentLoopData = Auth::user()->activeProductsByCountryAndBrand($country['id'], $product['brandId']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option id="opt_<?php echo e($prod->id); ?>_<?php echo e($country['id']); ?>" value="<?php echo e($prod->id); ?>"><?php echo e($prod->product->sku); ?> - <?php echo e($prod->product->global_name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                            <div class="col-xs-2">
                                                <button type="button" class="btn btn-default"
                                                        onclick="addProduct(<?php echo e($country['id']); ?>, <?php echo e(Auth::user()->activeProductsByCountryAndBrand($country['id'], $product['brandId'])); ?>)">
