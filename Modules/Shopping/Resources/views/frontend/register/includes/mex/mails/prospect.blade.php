                    ...
                    <tr>
                        <td>
                            ...
                            <div style="padding:15px; color:#666; margin-top:40px; ">
                                ...
                                <p>
                                    <strong>{{$data['name']}}</strong>,  @lang('shopping::register.mail.prospect.p.1.text.1')
                                </p>
                                <p>
                                    @lang('shopping::register.mail.prospect.p.1.text.2') <strong>{{$data['name_prospect']}}</strong> @lang('shopping::register.mail.prospect.p.1.text.3')
                                </p>
                                <p>
                                    @lang('shopping::register.mail.prospect.p.1.text.4')
                                </p>
                                <ul>
                                    <li><strong>@lang('shopping::register.mail.prospect.li.1'):</strong> {{$data['name_prospect']}}</li>
                                    @if($data['tel_prospect'] != null || $data['tel_prospect'] != '')
                                        <li><strong>@lang('shopping::register.mail.prospect.li.2'):</strong> {{$data['tel_prospect']}}</li>
                                    @endif
                                    @if($data['cel_prospect'] != null || $data['cel_prospect'] != '')
                                        <li><strong>@lang('shopping::register.mail.prospect.li.3'):</strong> {{$data['cel_prospect']}}</li>
                                    @endif
                                    <li><strong>@lang('shopping::register.mail.prospect.li.4'):</strong> {{$data['email_prospect']}}</li>
                                </ul>
                                    <br />

                                    <p>
                                        @lang('shopping::register.mail.prospect.p.1.text.5')                                    </p>
                                    <p>
                                        <small>@lang('shopping::register.mail.customer.unrecognized') <a href="mailto:privacidad@omnilife.com">@lang('shopping::register.mail.customer.mailprivacy')</a> @lang('shopping::register.mail.customer.subjectprivacy')</small>
                                    </p>
            ...
            <div class="content">
                <table>
                    <tr>
                        <td align="center">
                            <p>
                                <a href="https://portal.omnilife.com/politicas-de-privacidad">Privacy Policies</a>
                            </p>
                        </td>
                    </tr>
                </table>
