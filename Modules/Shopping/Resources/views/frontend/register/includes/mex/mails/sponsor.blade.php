...
<head>
    ...
    <title>@lang('shopping::register.mail.sponsor.title')</title>
            ...
            <div class="content">
                <table >
                    <tr>
                        ...
                        <td align="right"><h6 class="collapse" style="color:#FFFFFF">{!! trans('shopping::checkout.email.success_order.title_3') !!}</h6></td>
                    </tr>
                </table>
            </div>
        </td>
                ...
                <table bgcolor="#FFFFFF" >
                    <tr>
                        <td>
                            ...
                            <img src="{{asset('/uploads/images/mailing/assets/Ppal_sponsor.jpg')}}" alt="Nuevo Empresario"/><!-- /hero -->
                            <!-- Callout Panel -->
                            <div style="padding:15px; color:#666; margin-top:40px; ">
                                <h3 style="color:#892CAC; font-weight:800; font-size:21px;">@lang('shopping::register.mail.sponsor.subject', ['name_sponsor' => $data['name'], 'name_customer' => $data['name_customer']])</h3>
                                <p>
                                    @lang('shopping::register.mail.sponsor.p1', ['name_sponsor' => $data['name'], 'name_customer' => $data['name_customer']])

                                </p>
                                <p>
                                    @lang('shopping::register.mail.sponsor.p2')
                                </p>
                                    <ul>
                                        <li><strong>@lang('shopping::register.mail.sponsor.client_code'):</strong> {{$data['code_customer']}}</li>
                                        <li><strong>@lang('shopping::register.mail.sponsor.name'):</strong> {{$data['name_customer']}}</li>
                                        <li><strong>@lang('shopping::register.mail.sponsor.telephone'):</strong> {{$data['tel_customer']}}</li>
                                        <li><strong>@lang('shopping::register.mail.sponsor.email'):</strong> {{$data['email_customer']}}</li>
                                        <br />
                                    </ul>
                                <br/>

                                <p>
                                    <small>@lang('shopping::register.mail.sponsor.text2')</small>
                                </p>
                                <p>
