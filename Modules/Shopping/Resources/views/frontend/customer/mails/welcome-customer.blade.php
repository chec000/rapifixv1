...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#e2e1e0">
        ...
        <table class="body-wrap">
            <tr>
                <td></td>
                <td class="container" bgcolor="#FFFFFF" style="box-shadow: 0 14px 28px rgba(0,0,0,0.25), 0 10px 10px rgba(0,0,0,0.22);">
                    <div class="content">
                        <table bgcolor="#FFFFFF" >
                            <tr>
                                <td >
                                    <!-- A Real Hero (and a real human being) -->
                                    <img src="{{asset('/uploads/images/mailing/assets/Ppal_welcome.jpg')}}" alt="empresário Omnilife"/><!-- /hero -->
                                    <!-- Callout Panel -->

                                    <div style="padding:15px; color:#666; margin-top:40px; ">
                                        <h3 style="color:#892CAC; font-weight:800; font-size:24px;">@lang('shopping::register_customer.mail.customer.h3')</h3>

                                        <p>@lang('shopping::register_customer.mail.customer.p5')</p>

                                        <p>@lang('shopping::register_customer.mail.customer.p1'):</p>

                                        <ul>
                                            <li><strong>@lang('shopping::register_customer.mail.customer.li.1'):</strong> {{$data['code']}}</li>
                                            <li><strong>@lang('shopping::register_customer.mail.customer.li.2'):</strong> {{$data['password']}}</li>
                                            <li><strong>@lang('shopping::register_customer.mail.customer.li.3'):</strong> {{$data['question']}}</li>
                                            <li><strong>@lang('shopping::register_customer.mail.customer.li.4'):</strong> {{$data['answer']}}</li>
                                        </ul>

                                        <p>@lang('shopping::register_customer.mail.customer.p2')</p>

                                        <p>@lang('shopping::register_customer.mail.customer.p3.text1') <a href="{{url($data['url_login'])}}"><strong>@lang('shopping::register_customer.mail.customer.p3.text2')</strong></a></p>
                                    </div>

                                    <div style="padding: 15px; color:#666;">
                                        <p>
                                            <small>
                                                @lang('shopping::register_customer.mail.customer.p4.text1')
                                                <a href="mailto:privacidad@omnilife.com">privacidad@omnilife.com</a>
                                                {!! str_replace('{CREO}', $finalUrlCREO, trans('shopping::register_customer.mail.customer.p4.text2')) !!}
                                            </small>
                                        </p>
                                    </div>

                                    <div  align="center">
                                        <a href="https://portal.omnilife.com/cresiendo" target="_blank"><img src="{{asset($data['url_banner'])}}" alt="cresiendo" width="100%"></a>
                                    </div>
                    ...
                    <div class="content">
                        <table>
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href="{{\Illuminate\Support\Facades\URL::to('/')}}/politicas-de-privacidad" target="_blank">@lang('shopping::register_customer.mail.customer.a1')</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
