                ...
                <td class="header container">
                    <div class="content">
                        <table >
                            <tr>
                                <td>
                                    <img style="width: 170px;" src="{{asset($headerLogo)}}" />
                                </td>
                                <td align="right"><h6 class="collapse" style="color:#FFFFFF">@lang('shopping::register_customer.mail.sponsor.h6')</h6></td>
                            </tr>
                        </table>
                    </div>
                </td>
                        ...
                        <table bgcolor="#FFFFFF" >
                            <tr>
                                <td >
                                    ...
                                    <img src="{{asset('/uploads/images/mailing/assets/Ppal_new-customer.jpg')}}" alt="Nuevo Cliente Admirable"/><!-- /hero -->
                                    <!-- Callout Panel -->

                                    <div style="padding:15px; color:#666; margin-top:40px; ">
                                        <h3 style="color:#892CAC; font-weight:800; font-size:21px;">@lang('shopping::register_customer.mail.sponsor.h3', ['name' => $data['name']])</h3>

                                        <p>@lang('shopping::register_customer.mail.sponsor.p1.text1') <strong>{{$data['name_customer']}}</strong> @lang('shopping::register_customer.mail.sponsor.p1.text2')</p>

                                        <p>@lang('shopping::register_customer.mail.sponsor.p2'):</p>

                                        <ul>
                                            <li><strong>@lang('shopping::register_customer.mail.sponsor.li.1'):</strong> {{$data['code_customer']}}</li>
                                            <li><strong>@lang('shopping::register_customer.mail.sponsor.li.2'):</strong> {{$data['name_customer']}}</li>
                                            <li><strong>@lang('shopping::register_customer.mail.sponsor.li.3'):</strong> {{$data['tel_customer']}}</li>
                                            <li><strong>@lang('shopping::register_customer.mail.sponsor.li.4'):</strong> {{$data['email_customer']}}</li>

                                            <br>
                                            @lang('shopping::register_customer.mail.sponsor.ul')
                                        </ul>

                                        <br/>

                                        <p>
                                            <small>@lang('shopping::register_customer.mail.sponsor.p3.text1') <a href="mailto:privacidad@omnilife.com">privacidad@omnilife.com</a> {!! str_replace('{CREO}', $finalUrlCREO, trans('shopping::register_customer.mail.sponsor.p3.text2')) !!}</small>
                                        </p>
                    ...
                    <div class="content">
                        <table>
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href="{{\Illuminate\Support\Facades\URL::to('/')}}/politicas-de-privacidad" target="_blank">@lang('shopping::register_customer.mail.sponsor.a1')</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
