...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>@lang('shopping::register_customer.mail.verify.title')</title>
    ...
    <style>
        ...
        * { font-family: "Roboto", "Helvetica", Helvetica, Arial, sans-serif; }
        ...
        /* Style anchor tags inside the button td */
           .button a {
               color: #ffffff;
               display: block;
               font-size: 14px;
                    ...
                    <div class="content">
                        <table >
                            <tr>
                                ...
                                <td align="right"><h6 class="collapse" style="color:#FFFFFF">@lang('shopping::register_customer.mail.verify.h6')</h6></td>
                            </tr>
                        </table>
                    </div>
                </td>
                            ...
                            <tr>
                                <td >
                                    ...
                                    <div style="padding:15px; color:#666; margin-top:40px; ">
                                        <h3 style="color:#892CAC; font-weight:bold; font-size:24px;">@lang('shopping::register_customer.mail.verify.h3', ['name' => $data['name']])</h3>

                                        <br>

                                        <p>@lang('shopping::register_customer.mail.verify.p1'):</p>

                                        <br>

                                        <table>
                                            <tr>
                                                <td style="background-color: #690d81; border-color: #4c5764;border: 2px solid #690d81; padding: 10px;text-align: center;">
                                                    <a style="display: block; color: #ffffff;font-size: 12px;text-decoration: none;text-transform: uppercase;" href="{{route('registercustomer.activation') . '?code=' . $data['code']}}">
                                                        @lang('shopping::register_customer.mail.verify.a1')
                                                    </a>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <p><small>* @lang('shopping::register_customer.mail.verify.p2')</small></p>
                                    </div>
                    ...
                    <div class="content">
                        <table>
                            <tr>
                                <td align="center">
                                    <p>
                                        <a href="{{\Illuminate\Support\Facades\URL::to('/')}}/politicas-de-privacidad" target="_blank">@lang('shopping::register_customer.mail.verify.a2')</a>
                                    </p>
                                </td>
                            </tr>
                        </table>
