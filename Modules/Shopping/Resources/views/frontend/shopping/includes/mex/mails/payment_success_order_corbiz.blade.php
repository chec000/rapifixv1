					...
					<tr>
						<td>
							...
							<div style="padding:15px; color:#666; margin-top:40px; ">
								<h3 style="color:#892CAC; font-weight:800; font-size:21px;">{!! str_replace('{name}', $first_name, trans('shopping::checkout.email.success_order.p_hi')) !!}</h3>
								...
								<p><strong>{!! trans('shopping::checkout.email.success_order.p_4') !!}</strong>
									<ul>
										<li>{!! str_replace('{order}', $order_number, trans('shopping::checkout.email.success_order.p_5')) !!}</li>
										<li>{!! str_replace('{name}', $addr_name, trans('shopping::checkout.email.success_order.p_6')) !!}</li>
										<li>{!! str_replace('{address}', $address, trans('shopping::checkout.email.success_order.p_7')) !!}</li>
									</ul>
								</p>
								...
								@if (isset($items))
									...
									@if (isset($detail['discount'])) <p class="order-info"><span class="desc">@lang('shopping::checkout.quotation.resume_cart.discount'): {{ $detail['discount'] }}</span></p> @endif
									@if (isset($detail['subtotal'])) <p class="order-info"><span class="sub">@lang('shopping::shopping_cart.cart.bill.subtotal'): {{ $detail['subtotal'] }}</span></p> @endif
									@if (isset($detail['points'])) <p class="order-info"><span class="ponts">@lang('shopping::shopping_cart.cart.bill.points'): {{ $detail['points'] }}</span></p> @endif
									@if (isset($detail['management'])) <p class="order-info"><span class="hand">@lang('shopping::shopping_cart.cart.bill.management'): {{ $detail['management'] }}</span></p> @endif
									@if (isset($detail['taxes'])) <p class="order-info"><span class="tax">@lang('shopping::shopping_cart.cart.bill.taxes'): {{ $detail['taxes'] }}</span></p> @endif
									@if (isset($detail['total'])) <p class="order-info"><span class="total">@lang('shopping::shopping_cart.cart.bill.total'): {{ $detail['total'] }}</span></p> @endif
								@endif
