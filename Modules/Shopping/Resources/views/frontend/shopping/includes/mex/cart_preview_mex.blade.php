                        ...
                        <div class="cart-product__content">
                            ...
                            <div class="cart-product__bottom">
                                <div class="form-group numeric">
                                    <input id="input{{ $item['sku'] }}" class="form-control number"
                                    type="numeric" name="qty#{val}" value="{{ $item['quantity'] }}" disabled="disabled">
                                </div>
...
<div class="cart-preview-mov" id="cart-preview-mov">
    ...
    <div class="cart-preview__resume list-nostyle">
        <li class="points_mov">@lang('shopping::register.kit.bill.points'): {{ isset($points) ? $points : '0000' }}</li>
        <li class="total_mov">@lang('shopping::register.kit.bill.total'): {{ isset($total) ? $total : $subtotal }}</li>
    </div>
</div>