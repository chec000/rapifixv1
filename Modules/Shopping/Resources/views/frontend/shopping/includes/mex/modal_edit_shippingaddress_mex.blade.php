        ...
        <div class="">
            <div class="card__content">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group medium">
                        <input class="form-control" type="text" id="edit_suburb" name="edit_suburb" readonly="readonly" placeholder="@lang('shopping::shippingAddress.fields.suburb.placeholder')">
...
<script>
    ...
    $('#edit_zip').autocomplete({
        ...
        onSelect: function (suggestion) {
            ...
            $('#edit_suburb').attr('readonly', true);
