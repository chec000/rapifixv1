            ...
            <div class="card__content">
                ...
                {{ Form::open(array('url' => 'addShippingAddress','id'=>'form_addShippingAddress')) }}
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group medium">
                            <input class="form-control" readonly="readonly" type="text" id="county" name="county" placeholder="@lang('shopping::shippingAddress.fields.county.placeholder')">
                            <div class="error-msg" id="div_county"></div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group left">
                            ...
                            <div class="warning-msg" id="div_message_address" style="color:black;padding-top:5px;font-size: 14px;">@lang('shopping::register.info.address.street_message')</div>
...
<script>
    ...
    $('#zip').autocomplete({
        ...
        onSelect: function (suggestion) {
            ...
            $("#county").val(suggestion.data.county);
    ...
    function getZipCodeFromCorbiz(zip) {
        $.ajax({
            ...
            success: function(result) {
                ...
                $('#county').val(result.suggestions[0].data.county);
    ...
    $(document).on('keyup','#address',function(){
        ...
        $.ajax({
            ...
            success: function (result){
                ...
                if(result.passes){
                    $("#btnAddShippingAddress").attr('disabled',false);
                    $("#div_message_address").html('');
                    $("#div_message_address").html(result.message).css('color','black');
                }else{
                    $("#btnAddShippingAddress").attr('disabled',true);
                    $("#div_message_address").html('');
                    $("#div_message_address").html(result.message).css('color','red');
                }
            },
            error:function(result){
