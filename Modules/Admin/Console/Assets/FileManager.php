<?php namespace Modules\Admin\Console\Assets;
...
class FileManager extends AbstractAsset
{
    ...
    public function run()
    {
        ...
        File::insertAtLine($this->_baseFolder . '/config/config.php', [
            362 => [
                ...
                '\Modules\Admin\Helpers\FileManager::accessCheck();',
                '\Modules\Admin\Helpers\FileManager::setConfig($config, []);',
                ''
            ]
        ]);
        ...
        File::insertAtLine($this->_baseFolder . '/execute.php', [
            33 => [
                '\Modules\Helpers\FileManager::setSecureUpload($_POST[\'path\']);'
            ]
        ]);
        File::insertAtLine($this->_baseFolder . '/upload.php', [
            19 => [
                '   \Modules\Admin\Helpers\FileManager::setSecureUpload($_POST[\'path\']);'
            ],
            24 => [
                '   \Modules\Admin\Helpers\FileManager::setSecureUpload($_POST[\'fldr\']);'
            ]
        ]);
        ...
        File::replaceString($this->_baseFolder . '/include/utils.php', '0766', 'Modules\Admin\Helpers\FileManager::createDirPermissions()');
    ...
    protected function _updateConfigFile($configFile)
    {
        ...
        $fileContent = preg_replace(
            ...
            '\Modules\Admin\Helpers\FileManager::filemanager_set_permissions(\1);',
            $fileContent,
            -1,
            $count
        );
