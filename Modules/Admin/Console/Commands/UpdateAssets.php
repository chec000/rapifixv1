...
use Modules\Admin\Console\Assets as Assets;
...
class UpdateAssets extends Command
{
    ...
    {
        $this->_folders['public'] = public_path(trim(config('admin.config.public'), '/')) . '/';
        $this->_folders['storage'] = storage_path(trim(config('cms.site.storage_path'), '/')) . '/';
