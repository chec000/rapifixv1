...
<div class="textbox">
    <div class="col-sm-12">
        @if ($_block->getPageId())
            <p><a href="{!! route('admin.pages.edit', ['pageId' => $_block->getPageId()]) !!}">&raquo; Return and edit
                    other blocks / page info on the '{{ $paths->name }}' page</a></p>
        @else
            <p><a href="{!! route('admin.blocks') !!}">&raquo; Return and edit other
...
<?php $assets_path = URL::to(config('admin.config.public').'/jquery/gallery-upload') ?>
...
<script src="{!! URL::to(config('admin.config.public')) !!}/app/js/gallery.js"></script>
@stop
