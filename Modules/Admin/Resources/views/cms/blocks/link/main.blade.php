    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="input-group">
                ...
                <span class="input-group-addon">{{ trans('admin::blocks.link.or') }}</span>
                <span class="input-group-btn">
                    <a href="{!! URL::to(config('admin.config.public').'/filemanager/dialog.php?type=2&field_id='.$link_field_id) !!}"
                       class="btn btn-default iframe-btn">{{ trans('admin::blocks.link.button') }}</a>
                </span>
            </div>
        </div>
    </div>
