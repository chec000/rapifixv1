<h4>{{ trans('admin::pages.groups.header') }}</h4>
...
<div class="form-group" id="groupContainer">
    ...
    <div class="col-sm-2 col-xs-6">
        <label class="radio-inline">
            {!! Form::radio('page_info_other[group_radio]', 1, $page->group_container ? 1 : 0) !!}
            {{ trans('admin::pages.groups.yes') }}
        </label>
        <label class="radio-inline">
            {!! Form::radio('page_info_other[group_radio]', 0, $page->group_container ? 0 : 1) !!}
            {{ trans('admin::pages.groups.no') }}
        </label>
    </div>
    <div class="col-sm-7 col-xs-8 group-container-options">
        <select name="page_info[group_container]" title="Group Container" class="form-control">
            <option value="-1">-- {{ trans('admin::pages.groups.new') }} --</option>
            <option value="0">-- {{ trans('admin::pages.groups.top_level') }} --</option>
