        ...
        <table class="table table-striped">
            ...
            @foreach($requests as $request)
                <tr>
                    ...
                    @endif
                    <td>
                        <a href="{{ Modules\CMS\Helpers\Page\Path::getFullUrl($request->page_version->page_id).'?preview='.$request->page_version->preview_key }}"
                           target="_blank"><i class="glyphicon glyphicon-eye-open itemTooltip" title="Preview"></i></a>
                        <a href="{{ route('admin.pages.edit', ['pageId' => $request->page_version->page_id, 'version' => $request->page_version->version_id]) }}"><i
