<h1> {{trans('admin::shopping.registrationreferences.update.updateoe')}}</h1>
...
{!! Form::open( ['id'=>'form_update_registrationreferences']) !!}
<input type="hidden" value="{!!$registrationreferences->id!!}" name="id_registration_references">
<div class="row">
    ...
    <fieldset class="fieldset_gray">
        ...
        <div class="col-md-6">
            <div  class= "form-group {!! FormMessage::getErrorClass('key') !!}">
                ...
                {!! Form::text('key', isset($registrationreferences->key_reference) ? $registrationreferences->key_reference:'', ['required','class' => 'form-control','id'=>'key']) !!}
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input  class="form-control" name="registrationreferences_name[{{$lan->locale_key}}]" value="{{$lan->name or old('registrationreferences_name.'.$lan->locale_key)}}" type="text">
                        <input  class="form-control" name="registrationreferences_locale[]" value="{!!$lan->locale_key !!}" type="hidden">
                    </div>
...
<div class="form-group">
    ...
    {!!Form::submit(trans('admin::shopping.registrationreferences.update.btn_update'),[ 'class'=>'btn btn-primary addButton'])!!}
