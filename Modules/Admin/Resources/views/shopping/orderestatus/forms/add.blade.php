    ...
    <legend class="legend_gray">{!! trans('admin::shopping.orderestatus.add.legend_add') !!}</legend>
        <div class="col-md-6">
            <div  class= "form-group {!! FormMessage::getErrorClass('key') !!}">
                ...
                {!! Form::text('key', isset($orderestatus->key)? $orderestatus->key:'', ['required','class' => 'form-control','id'=>'key']) !!}
             ...
             class="panel-collapse {{($lan['id'] == Session::get('language') || $errors->has('role_data['.$lan->id.'][name]')) ? 'in' : 'collapse'}}" >
                     <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <input  class="form-control" name="orderestatus_name[{{$lan->locale_key}}]" value="{{ old('orderestatus_name.'.$lan->locale_key) }}" type="text">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input class="form-control"  name="description[{{$lan->locale_key}}]" value="{{ old('description.'.$lan->locale_key) }}" type="text">
                            <input type="hidden" name="orderestatus_locale[]" value="{!! $lan->locale_key!!}">
...
<div class="form-group">
        ...
        {{trans('admin::shopping.orderestatus.add.btn_add')}}
    </button>
