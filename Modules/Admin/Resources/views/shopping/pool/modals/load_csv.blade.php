    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ trans('admin::distributorsPool.general.load_csv') }}</h4>
            </div>
            ...
            <div class="modal-body">
                <form id="csv_form" method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <ol>
                            <li>{{ trans('admin::distributorsPool.csv.inst_01') }}: <a href="{{ asset('files/pool.csv') }}">{{ trans('admin::distributorsPool.csv.file_demo') }}</a></li>
                            <li>{{ trans('admin::distributorsPool.csv.inst_02') }}</li>
                            <li>{{ trans('admin::distributorsPool.csv.inst_03') }}</li>
                        </ol>
                    </div>
                </form>
