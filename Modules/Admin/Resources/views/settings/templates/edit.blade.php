...
<h1>{!!trans('admin::template.update_template')!!}</h1>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group {!! FormMessage::getErrorClass('template') !!}">
            ...
            <input id="template" type="text" value="{{$template->template}}" class="form-control" name="template">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input   class="form-control" name="name_lang[]" value="{{$lan->label}}" type="text">
...
<!-- submit button -->
<button type="submit" class="btn btn-primary addButton"><i class="fa fa-edit"></i> &nbsp; {{ isset($countryEdit->id) ? trans('admin::countries.add_button') : trans('admin::countries.edit_button') }}</button>
