    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="categories" method="POST" action="{{ route('admin.kiosco.disclaimer.store') }}">
                    {{ csrf_field() }}
                        ...
                        <div id="products-check-countries">
                            ...
                            @foreach($countriesUser as $cu)
                                <div data-country-checkbox="{{ $cu->id }}" name="check-countries">
                                    <input class="form-check-input" id="checkCountry_{{ $cu->id }}" value="{{ $cu->id }}" type="checkbox" onclick="enableNextButton()">
