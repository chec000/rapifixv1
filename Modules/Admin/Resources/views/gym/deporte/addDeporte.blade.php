            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="precio" type="number" min="1" class="form-control{{ $errors->has('precio') ? ' is-invalid' : '' }}" name="precio" value="{{ old('name') }}" required autofocus>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 {!! FormMessage::getErrorClass('imagen') !!}" >
                            ...
                            <input id="flag" class="img_src form-control" name="imagen" value="" type="text">
