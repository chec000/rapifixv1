...
<html>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="index2.html" class="logo"><b>PROYECTO GYM</b></a>
            ...
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="admintempate/dist/img/user3-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="admintempate/dist/img/user4-128x128.jpg" class="img-circle" alt="user image"/>
                          </div>
                          <h4>
                            Developers
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">jahsaj</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
  ...
  <div class="pull-left image">
   <img src="" class="user-image img-circle"/>
  </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-yellow">
                ...
                <a href="{{route('admin.client.list_clientes')}}" class="small-box-footer">Nuevos Clientes <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div><!-- ./col -->
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
 ...
 <!-- quick email widget -->
    ...
    <!-- Bootstrap 3.3.2 JS -->
    <script src="{!! asset('/admintempate/bootstrap/js/bootstrap.min.js') !!} " type="text/javascript"></script>
    <!-- Morris.js charts -->
