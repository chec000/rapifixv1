<?php namespace Modules\Admin\Helpers\Validation;
	...
	public static function generateJson($migrationsFolder = null)
	{
		...
		foreach (scandir($migrationsFolder) as $file) {
            ...
            $migration = str_replace(
                ...
                '
                use Illuminate\Database\Migrations\Migration;
                use Modules\Admin\Helpers\Validation\Database\Blueprint;
                use Modules\Admin\Helpers\Validation\Database\Schema;
                use Modules\Admin\Helpers\Validation\Database\DB;',
                $migration
            );
