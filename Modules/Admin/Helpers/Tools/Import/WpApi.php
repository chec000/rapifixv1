<?php namespace Modules\Admin\Helpers\Tools\Import;
...
class WpApi
{
    ...
    public function createGroupPage($name, $item_name, $template_name, $item_template_name = '')
    {
      ...
      $groupPageLang->language_id = \Modules\Admin\Entities\Language::current();
    ...
    public function createPost($data)
    {
      ...
      $pageLang->language_id = \Modules\Admin\Entities\Language::current();
      ...
      $title_block = Block::where('name', '=', config('admin.config.title_block'))->first();
      if (!empty($title_block)) {
