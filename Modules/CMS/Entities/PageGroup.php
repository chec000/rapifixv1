...
class PageGroup extends Eloquent
{
     ...
     * @var string
     */
    protected $table = 'cms_page_group';
    ...
    {
        return $this->hasMany('Modules\CMS\Entities\PageGroupAttribute', 'group_id')->orderBy('item_block_order_priority', 'desc');
    }
    ...
    {
        return $this->belongsToMany('Modules\CMS\Entities\Page', 'cms_page_group_pages', 'group_id', 'page_id');
    }
