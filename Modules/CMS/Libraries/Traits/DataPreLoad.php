<?php namespace Modules\CMS\Libraries\Traits;
...
trait DataPreLoad
{
    ...
    {
     //      dd([$version, $pageId, $blockId,$language_id, $brandId, $countryId]);    
    ...
    protected static function _preloadGetBlock($customDataSetKey = 'default', $key)
    {
    $data = static::_preloadGetArray($customDataSetKey);        
