...
use Modules\Admin\Helpers\Import\BlocksCollection;
use Modules\CMS\Helpers\File\Directory;
use Modules\CMS\Helpers\Page\PageLoaderDummy;
use Modules\CMS\Libraries\Builder\PageBuilder\ThemeBuilderInstance;
...
use Modules\CMS\Entities\ThemeBlock;
use Modules\CMS\Entities\ThemeTemplate;
use Modules\CMS\Entities\ThemeTemplateBlock;
...
class BlocksImport extends AbstractImport
{
    ...
    {
        $categoryImport = new \Modules\CMS\Libraries\Import\Blocks\CategoryImport;
        ...
        $formRulesImport = new \Modules\CMS\Libraries\Import\Blocks\FormRulesImport();
    ...
    {
        $this->_blocksCollection->setScope($scope);
        $blockIds = array_map(function(\Modules\Admin\Helpers\Import\Block $currentBlock) {
    ...
    /**
     * @param \Modules\Admin\Helpers\Import\Block[] $allBlockData
     */
    ...
    public function save($updateTemplates)
    {
        ...
        $selectOptionsImport = new \Modules\CMS\Libraries\Import\Blocks\SelectOptionImport;
    ...
    /**
     * @param \Modules\Admin\Helpers\Import\Block[] $allBlockData
     * @return \Modules\Admin\Helpers\Import\Block[]
     */
