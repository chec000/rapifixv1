...
use Artisan;
use Carbon\Carbon;
use Modules\CMS\Helpers\Routes;
use Modules\CMS\Helpers\File\File;
...
class InstallController extends Controller
{
    ...
    public function checkPermissions($next = false)
    {
        ...
        $this->layoutData['content'] = View::make('admin::cms.install', ['stage' => 'permissions', 'dirs' => $dirs, 'continue' => $continue]);
        return null;
    }
    ...
    public function setupDatabase()
    {
        ...
        $this->layoutData['content'] = View::make('admin::cms.install', ['stage' => 'database', 'allowPrefix' => $allowPrefix]);
    }
    ...
    public function runDatabaseMigrations($skipEnvCheck = false)
    {
        ...
        if (!$skipEnvCheck && $unMatchedEnvVars) {
            ...
            $this->layoutData['content'] = View::make('admin::cms.install', ['stage' => 'envCheck', 'unMatchedEnvVars' => $unMatchedEnvVars]);

        } else {
            Artisan::call('migrate', ['--path' => '/Modules/CMS/Database/Migrations']);
    ...
    public function setupAdminUser()
    {
        ...
        $this->layoutData['content'] = View::make('admin::cms.install', ['stage' => 'adduser', 'currentUsers' => User::count()]);
    }
    ...
    public function setupTheme()
    {
        ...
        $this->layoutData['content'] = View::make('admin::cms.install', ['stage' => 'theme', 'themes' => $themes, 'defaultTheme' => 'coaster2017']);
    }
    ...
    public function installTheme()
    {
        ...
        if (!Request::exists('theme') || $error) {
            ...
            $this->layoutData['content'] = View::make('admin::cms.install', ['stage' => 'complete']);
        }
    }
