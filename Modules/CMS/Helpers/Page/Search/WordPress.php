<?php namespace Modules\CMS\Helpers\Page\Search;
        ...
        if ($this->_databaseConnection) {
            ...
            if ($blogPosts) {
                ...
                foreach ($blogPosts as $blogPost) {
                    ...
                    $postData->fullName = ucwords(str_replace('/', ' ', config('cms.blog.url'))) . $defaultSeparator->separator . $blogPost['post_title'];
                    $postData->fullUrl = config('cms.blog.url') . $blogPost['post_name'];
