                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="carwrap">
                            ...
                            @else
                                <a {!! PageBuilder::block('slide_button_link') !!} class="btn btn-default">{{ PageBuilder::block('slide_button_text') }}{!! PageBuilder::block('slide_button_icon')?' &nbsp; '.PageBuilder::block('slide_button_icon'):'' !!}</a>
                            @endif
                        </div>
                    </div>
                </div>
