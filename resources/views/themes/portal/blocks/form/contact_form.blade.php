        ...
        <div class="col-sm-9">
            <div class="form-group">
                ...
                <object type="application/x-shockwave-flash" data="/coaster/securimage/securimage_play.swf?audio_file=/securimage/securimage_play.php" width="19" height="19">
                    <param name="movie" value="/cms/securimage/securimage_play.swf?audio_file=/securimage/securimage_play.php&amp;bgColor1=#fff&amp;bgColor2=#fff&amp;iconColor=#777&amp;borderWidth=1&amp;borderColor=#000" />
                </object> &nbsp;&nbsp;
                <a href="#" onclick="document.getElementById('captcha').src = '/cms/securimage/securimage_show.php?' + Math.random(); return false">[ Refresh Captcha ]</a>
