<section class="search">
    <div class="wrapper">
        <div class="form-group">
            <input id="global-search" class="form-control form-control--search" type="input" name="search" placeholder="@lang('cms::search.input_placeholder')">
        ...
        <div id="global-search-container" class="search-results" style="display: none">
            ...
            <div id="global-search-empty" style="display: none">
                <div class="search-result product">
                    <h3 class="product__name">@lang('cms::search.empty_title')</h3>
                    <div class="product__content">
                        <p class="product__description">@lang('cms::search.empty_description')</p>
                    </div>
                </div>
            </div>
        </div>
