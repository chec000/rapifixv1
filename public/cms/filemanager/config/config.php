...
$config = array(
	...
	*/
	...
	'previewable_text_file_exts'              => array( 'txt', 'log', 'xml', 'html', 'css', 'htm', 'js' ,'csv'),
	...
	'googledoc_file_exts'                     => array( 'doc', 'docx', 'xls', 'xlsx', 'ppt', 'pptx','csv' ),

	// Preview with Viewer.js
	'viewerjs_enabled'                        => true,
	'viewerjs_file_exts'                      => array( 'pdf', 'odt', 'odp', 'ods' ,'csv'),
	...
	'ext_video'                               => array( 'mov', 'mpeg', 'm4v', 'mp4', 'ogv', 'avi', 'mpg', 'wma', "flv", "webm" ), //Video
...
require __DIR__ .'/../../../../Modules/Admin/hooks/laravel.php';
...
return array_merge(
	...
	array(
		...
		'ext'=> array_merge(
			...
			$config['ext_file'],
			$config['ext_misc'],
			config('settings::upload.video') == 1 ? $config['ext_video'] : [],
			$config['ext_music']
		),
