...
function update_version_table() {
    $.ajax({
        url: route('admin.pages.versions', {pageId: page_id}),
        data: {
...
function version_rename() {
    $.ajax({
        url: route('admin.pages.version-rename', {pageId: page_id}),
        type: 'POST',
        data: {
...
function version_publish() {
    version_id = $(this).data('version');
    $.ajax({
        url: route('admin.pages.version-publish', {pageId: page_id}),
        type: 'POST',
        data: {
            version_id: version_id
        },
...
function version_publish_schedule() {
    ...
    $.ajax({
        url: route('admin.pages.version-schedule', {pageId: page_id}),
        type: 'POST',
        data: {
            version_id: version_id,
...
function request_publish() {
    ...
    if (version_id === undefined) {
        ...
        $.ajax({
            url: route('admin.pages.request-publish', {pageId: page_id}),
            type: 'POST',
            data: {
                version_id: version_id,
                note: note
...
function request_publish_action() {
    ...
    $.ajax({
        url: route('admin.pages.request-publish-action', {pageId: request_page_id}),
        type: 'POST',
        data: {
            request: request_id,
...
function update_request_table(page) {
    ...
    $.ajax({
        url: route('admin.pages.requests', {pageId: page_id}),
        data: data,
        type: 'POST',
        success: function(r) {
            $('.itemTooltip').tooltip('hide');
