...
function remove(element) {
  ...
  function searchPages(name){
              ...
              var language=$("#select_language_id").val();
                ...
                data: {brand_id:brand,country_id:country,language_id:language,name:name},
                success: function(r)
                {
...
},{"./gotostep":2,"./helpers":3,"./jumbotron":4,"./numeric-input":6,"./openClose":7,"./search":8,"./slider":9,"./tabs":10,"perfect-scrollbar":1}],6:[function(require,module,exports){
'use strict';
...
$( document ).ready( showSurveyExist );
   ...
   function showSurveyExist(){
    var flat_survay = localStorage.getItem('made_survay');
